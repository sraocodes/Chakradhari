/* =========================================================
   ...
   Renders Watch (channels) and Use (repositories + toolboxes) from
   js/data/open-science-data.js. Read and Reproduce aren't built yet
   — there's nothing real to put in them; add a render function
   here, following this file's pattern, when that changes.
   Use always renders: real cards, or a restrained "coming soon"
   line — never a fake placeholder card. Watch stays out of the DOM
   entirely if channels is ever emptied.
   ========================================================= */
import './shared.js';
import { channels, repositories, toolboxes } from '../data/open-science-data.js';
